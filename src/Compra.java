...
public class Compra implements Serializable {
    ...
    /**
     *
     * @param codigoCli String com o nome de um produto a ser colocada na
     * instância
     */
    ...
    /**
     *
     * @param codigoProd String com o nome de um cliente a ser colocada na
     * instância
     */
    ...
    /**
     *
     * @param modo Corresponde ao modo em que foi feita uma compra (N/P) a ser
     * colocado na instância
     */
    ...
    /**
     *
     * @param valorUni Corresponde ao preço de uma unidade de um produto a ser
     * colocada na instância
     */
    ...
    /**
     * Teste de igualdade entre uma instância de Compra e uma outra qualquer
     * instância
     *
     ...
     * @throws MalformedCompraException Se a linha a processar não estiver conforme a especificação
     */
    public static Compra parseCompra(String st) throws MalformedCompraException {
        StringTokenizer strtok = new StringTokenizer(st);
        if (strtok.countTokens() != 6) {
            throw new MalformedCompraException(st);
        } else {
            String codigoProd, codigoCli;
            float valorUni;
            char modo;
            int qtd, mes;
            codigoProd = strtok.nextToken();
            valorUni = Float.parseFloat(strtok.nextToken());
            qtd = Integer.parseInt(strtok.nextToken());
            modo = strtok.nextToken().charAt(0);
            codigoCli = strtok.nextToken();
            mes = Integer.parseInt(strtok.nextToken());
            return new Compra(codigoProd, valorUni, qtd, modo, codigoCli, mes);
        }
